...
def get_results(graph_path1, graph_path2):
    ...
    spearman = get_spearman.get_spearman(graph_path1, graph_path2)

    result_dic = {}
    result_dic["communities"] = subgraph1_num
    result_dic["average community size"] = subgraph1_size
    result_dic["spearman coefficient"] = spearman[0]
    result_dic["p-value"] = spearman[1]
...
def get_b_cubed(graph_path1, graph_path2, model_type, output_file, threshold, return_scores=False):
